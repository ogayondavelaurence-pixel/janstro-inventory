...
/**
 * ============================================================================
 * USER CONTROLLER - COMPLETE FIXED VERSION
 * ============================================================================
 * Path: src/Controllers/UserController.php
 * 
 * FIXES APPLIED:
 * ✅ Added profile_picture to getCurrentUser() SELECT query (line 31)
 * ✅ Added profile_picture to getCurrentUser() response (line 50)
 * ✅ All profile picture upload/remove methods included
 * ============================================================================
 */
...
class UserController
{
    ...
    /* ========================================================================
       GET /users/current - ✅ FIXED VERSION
       ======================================================================== */
    public function getCurrentUser(): void
    {
        ...
        try {
            // ✅ FIX: Added u.profile_picture to SELECT
            ...
            // ✅ FIX: Added profile_picture to response
            Response::success([
                ...
                'profile_picture' => $userData['profile_picture'] ?? null  // ✅ CRITICAL FIX
    ...
    /**
     * ✅ ENHANCED: Remove profile picture (deletes physical files)
    ...
    /**
     * ✅ NEW HELPER: Format bytes for human readability
     */

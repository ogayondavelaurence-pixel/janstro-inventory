...
class OrderController
{
    ...
    /* GET /api/orders/{id}; Get purchase order by ID (ALL ROLES) */
    ...
    /* POST /api/orders; Create purchase order (STAFF/ADMIN/SUPERADMIN) */
    ...
    /* POST /api/orders/{id}/approve; Approve purchase order (ADMIN ONLY) */
    ...
    /* POST /api/orders/{id}/cancel; Cancel purchase order (ADMIN ONLY) */

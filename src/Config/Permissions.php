...
class Permissions
{
    ...
    /* Page Access Control; FIXED: Clear separation between admin and superadmin */
    const PAGE_ACCESS = [
        // ===================================
    ...
    /*Action-Level Permissions; FIXED: Granular control differentiating admin vs superadmin */
    const ACTIONS = [
        'inventory' => [

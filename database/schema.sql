...
BEGIN
    ...
    read_loop: LOOP
        ...
        UPDATE items
        SET quantity = quantity - (v_required_qty * NEW.quantity),
...
BEGIN
    ...
    WHILE @i < JSON_LENGTH(p_items) DO
        ...
        INSERT INTO sales_order_items (
            ...
            v_order_id,
            JSON_UNQUOTE(JSON_EXTRACT(v_item, '$.item_id')),
            v_quantity,
            v_price,
            v_quantity * v_price
        );
...
BEGIN
    ...
    SET paid_amount = paid_amount + p_amount,
        paid_status =
            ...
            END,
        paid_date = IF(
            paid_amount + p_amount >= total_amount,
            CURRENT_TIMESTAMP,
            NULL
        )
...
BEGIN
    ...
    SELECT
        CONCAT('INV-', LPAD(p_order_id, 6, '0')),
        order_id,
        customer_id,
        v_total,
        p_generated_by
    ...
    read_loop: LOOP
        ...
        ELSE
            ...
            INSERT INTO transactions (
                ...
                'OUT',
                v_qty,
                CONCAT('Reserved for Sales Order #', p_order_id)
            );
        END IF;
    END LOOP;

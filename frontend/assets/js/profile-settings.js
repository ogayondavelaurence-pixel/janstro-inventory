/**
 * ============================================================================
 * PROFILE SETTINGS MODULE v5.0 - PRODUCTION READY
 * ============================================================================
 * Path: frontend/assets/js/profile-settings.js
 *
 * FIXES v5.0:
 * ✅ Direct public URL access (no proxy)
 * ✅ Works with public/assets/uploads/profile_pictures/
 * ✅ No token needed in image URLs
 * ✅ Simplified loadProfilePicture() function
 * ============================================================================
 */
(async function () {
  "use strict";
  ...
  // ========================================================================
  // LOAD PROFILE PICTURE - FIXED v5.0 (DIRECT PUBLIC ACCESS)
  // ========================================================================
  function loadProfilePicture() {
    ...
    if (profilePicture && profilePicture.trim() !== "") {
      ...
      // ✅ PUBLIC PATH - Direct browser access (NO PROXY)
      else {
        imageSrc = BASE_URL + profilePicture;
        console.log("🖼️ Using public URL:", imageSrc);
      }
  ...
  document.addEventListener("DOMContentLoaded", async () => {
    console.log("🔧 Profile Settings v5.0: Public directory mode");
    await loadUserProfile();
    setupEventListeners();
  });

  console.log("✅ Profile Settings Module v5.0 Loaded");
})();

/**
 * ============================================================================
 * JANSTRO IMS - UTILITY FUNCTIONS v7.1 COMPLETE
 * ============================================================================
 * Path: frontend/assets/js/utils.js
 *
 * WHAT THIS FILE DOES:
 * - Provides common helper functions used throughout the application
 * - Handles formatting (currency, dates, phone numbers)
 * - Manages UI feedback (toasts, loading states, confirmations)
 * - Validates user input (email, phone, etc.)
 * - Exports data (CSV, JSON)
 * - Common DOM manipulation helpers
 *
 * CHANGELOG v7.1:
 * ✅ Fixed toast notifications (Bootstrap 5 compatible)
 * ✅ Enhanced currency formatting for Philippine Peso
 * ✅ Improved phone number validation (Philippine format)
 * ✅ Added debounce for search inputs
 * ✅ Better CSV export with proper encoding
...
console.log("✅ Utils v7.1 Complete Loaded");
console.log("🛠️ 30+ helper functions available");
